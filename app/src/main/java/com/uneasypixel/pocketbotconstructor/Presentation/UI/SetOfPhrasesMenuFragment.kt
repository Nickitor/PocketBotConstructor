...
class SetOfPhrasesMenuFragment : Fragment() {

    // Объект привязки для получения объектов интерфейса
    private var _binding: FragmentSetOfPhrasesMenuBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSetOfPhrasesMenuBinding.inflate(inflater, container, false)
        return binding.root
    }
